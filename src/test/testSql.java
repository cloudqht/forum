...
public class testSql {
    ...
    public static void main(String[] args)  {
        ...
        String a = requestMethod(HTTP_GET, "https://api.weixin.qq.com/sns/jscode2session","appid=wxdd18ab49b8eb93c8&secret=f0e468385f1210d472597e72e8c3428f" +
                "&js_code=033xcfay0VWWpg1VDK8y0wHZ9y0xcfaE&grant_type=authorization_code");
        Gson gson = new Gson();
        userSecret b = gson.fromJson(a,userSecret.class);
        openIdUtil openIdUtil = new openIdUtil();
        String openId = openIdUtil.getUserOpenId("023eAgYe2oi2UB0rb6Ye2VeaYe2eAgY4");
